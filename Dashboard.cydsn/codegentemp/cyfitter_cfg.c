...
#define BS_IOPORT_0_VAL ((const uint8 CYFAR *)0x48000618u)

/* IOPORT_4 Address: CYDEV_PRTDSI_PRT4_BASE Size (bytes): 7 */
#define BS_IOPORT_4_VAL ((const uint8 CYFAR *)0x48000620u)

/* IOPINS0_0 Address: CYREG_PRT0_DR Size (bytes): 10 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000628u)
...
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000654u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000660u)

/* IOPINS0_5 Address: CYREG_PRT5_DR Size (bytes): 10 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000668u)

/* IOPINS0_6 Address: CYREG_PRT6_DM0 Size (bytes): 8 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000674u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800067Cu)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT3_AG, 0x04u);
...
uint8 CYXDATA * const CYCODE ADC_GLV_V_AMux__addrTable[2] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADC_GLV_V_AMux__maskTable[2] = {
	0x40u, 
	0x00u, 
};

/*******************************************************************************
* Function Name: ADC_GLV_V_AMux_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_GLV_V_AMux_Set(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_GLV_V_AMux__addrTable[channel] |= ADC_GLV_V_AMux__maskTable[channel];
	}
}

/*******************************************************************************
* Function Name: ADC_GLV_V_AMux_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ADC_GLV_V_AMux_Unset(uint8 channel)
{
	if (channel < 2)
	{
		*ADC_GLV_V_AMux__addrTable[channel] &= (uint8)~ADC_GLV_V_AMux__maskTable[channel];
	}
}
